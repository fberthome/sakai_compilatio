...
public interface ContentReviewService {
	...
	/**
	 *  Add an item to the Queue for Submission to Compilatio
	 *  
	 ...
	 *  
	 */
	public String queueContent(String userId, String siteId, String taskId, String contentId)
	...
	/**
	 * Get the errorCode of a submission
	 * @param contentId
	 * @return
	 * @throws QueueException
	 */
	public Integer getReviewErrorCode(String contentId)
	throws QueueException;
	 ...
	 * 
	 * In the Compilatio implementation this provides all the return information
	 ...
	 * 
	 * For the Compilatio implementation these keys map to some input 
	 * parameters for Fid4 Fcmd 2/3. These can be seen in Compilatio's API
	 * documentation.
	 * 
	...
	/**
	 *  Retrieve a externalId for a specific item
	 * @param contentId
	 * @return the origionality score
	 * @throws QueueException
	 * @throws ReportException
	 * @throws Exception
	  */
	public String getExternalId(String contentId)
	throws QueueException;
	
	
	/**
	 * Add Document to compilatio
	 */
