...
public class ContentReviewItem {
	...
	public static final String NOT_SENDED = "Content awaiting sendind";
	public static final Long NOT_SENDED_CODE = new Long(1);
	
	public static final String MANUAL = "Content awaiting manual submission";
	public static final Long MANUAL_CODE = new Long(2);
	
	public static final String NOT_SUBMITTED = "Content awaiting submission";
	public static final Long NOT_SUBMITTED_CODE = new Long(3);
	
	
	public static final String SUBMITTED_AWAITING_REPORT = "Content submitted for review and awaiting report";
	public static final Long SUBMITTED_AWAITING_REPORT_CODE= new Long(4);
	
	public static final String SUBMITTED_REPORT_AVAILABLE = "Content submitted and report available";
	public static final Long SUBMITTED_REPORT_AVAILABLE_CODE = new Long(5);
	
	public static final String SUBMISSION_ERROR_RETRY = "Temporary error occurred submitting content - will retry";
	public static final Long SUBMISSION_ERROR_RETRY_CODE = new Long(6);
	
	public static final String SUBMISSION_ERROR_NO_RETRY = "Error occurred submitting content - will not retry";
	public static final Long SUBMISSION_ERROR_NO_RETRY_CODE = new Long(7);
	...
	public static final Long SUBMISSION_ERROR_USER_DETAILS_CODE = new Long(8);
	
	public static final String REPORT_ERROR_RETRY = "Temporary error occurred retrieving report - will retry";
	public static final Long REPORT_ERROR_RETRY_CODE = new Long(9);
	
	public static final String REPORT_ERROR_NO_RETRY = "Error occurred retrieving report - will not retry";
	public static final Long REPORT_ERROR_NO_RETRY_CODE = new Long(10);
	
	public static final Long SUBMISSION_ERROR_RETRY_EXCEEDED = new Long(11);
	
	public static final String SENDING_ERROR_RETRY = "Temporary error occurred sending content - will retry";
	public static final Long SENDING_ERROR_RETRY_CODE = new Long(6);
	...
	public enum Error {
		...
		public static Error find(int faultCodeInt) {
