...
public class CompilatioContentValidator {
	...
	/**
	 * Default max allowed filesize - should match compilatios own setting (surrently 20Mb)
	 */
	...
	public void init() {
		tii_Max_Fil_Size = serverConfigurationService.getInt("compilatio.maxFileSize", TII_DEFAULT_MAX_FILE_SIZE);
	}
